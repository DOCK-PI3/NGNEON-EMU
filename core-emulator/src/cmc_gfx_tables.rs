// Generated mechanically from FBNeo neo_decrypt.cpp CMC50/KOF2000 and CMC42/KOF99 tables.

// ── CMC42 (KOF99) tables ───────────────────────────────────────────────

pub(super) const KOF99_TYPE0_T03: [u8; 256] = [
...
pub(super) const KOF99_TYPE0_T12: [u8; 256] = [
...
pub(super) const KOF99_TYPE1_T03: [u8; 256] = [
...
pub(super) const KOF99_TYPE1_T12: [u8; 256] = [
...
pub(super) const KOF99_ADDRESS_8_15_XOR1: [u8; 256] = [
...
pub(super) const KOF99_ADDRESS_8_15_XOR2: [u8; 256] = [
...
pub(super) const KOF99_ADDRESS_16_23_XOR1: [u8; 256] = [
...
pub(super) const KOF99_ADDRESS_16_23_XOR2: [u8; 256] = [
...
pub(super) const KOF99_ADDRESS_0_7_XOR: [u8; 256] = [
...
// ── CMC50 (KOF2000) tables ──────────────────────────────────────────────

pub(super) const KOF2000_TYPE0_T03: [u8; 256] = [
...
pub(super) const KOF2000_TYPE0_T12: [u8; 256] = [
...
pub(super) const KOF2000_TYPE1_T03: [u8; 256] = [
...
pub(super) const KOF2000_TYPE1_T12: [u8; 256] = [
...
pub(super) const KOF2000_ADDRESS_8_15_XOR1: [u8; 256] = [
...
pub(super) const KOF2000_ADDRESS_8_15_XOR2: [u8; 256] = [
...
pub(super) const KOF2000_ADDRESS_16_23_XOR1: [u8; 256] = [
...
pub(super) const KOF2000_ADDRESS_16_23_XOR2: [u8; 256] = [
...
pub(super) const KOF2000_ADDRESS_0_7_XOR: [u8; 256] = [
