...
Para preparar una instalación nueva, copia `config/ngneon.example.conf` como
`config/ngneon.conf`. El archivo real se excluye de Git porque puede contener
rutas locales y credenciales de RetroAchievements.
